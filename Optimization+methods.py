...
def update_parameters_with_momentum(parameters, grads, v, beta, learning_rate):
    ...
    for l in range(L):
        ...
        # compute velocities
        v["dW" + str(l+1)] = beta*v["dW" + str(l+1)] + (1-beta)*grads["dW%s" % (l+1)]
        v["db" + str(l+1)] = beta*v["db" + str(l+1)] + (1-beta)*grads["db%s" % (l+1)]
        # update parameters
...
#         ### START CODE HERE ### (approx. 2 lines)
        # v_corrected["dW" + str(l+1)] = v["dW" + str(l+1)] / (1-(math.pow(beta1,2)))
